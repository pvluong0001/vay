...
swiper__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_0__["Pagination"]]); // import Swiper styles


new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.swiper-container');
new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.branch-slide', {
  slidesPerView: 6,
  spaceBetween: 25,
  loop: true,
  centeredSlides: true
});
new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.comment-slide', {
  pagination: {
    el: '.swiper-pagination-comment'
  }
});
new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.knowledge-slide', {
  slidesPerView: 4,
  spaceBetween: 25,
  pagination: {
...
window.initTab = function () {
  ...
  var _loop = function _loop(i) {
    ...
    var tabPanels = element.querySelectorAll('.tab');

    if (tabPanels) {
      tabsObj[i].panel = tabPanels[0];
      tabsObj[i].panel.classList.add('active');
      var firstTabContent = document.querySelector("[data-tab=\"".concat(tabsObj[i].panel.dataset.href, "\"]"));
      ...
      Array.from(tabPanels).forEach(function (element) {
        return element.addEventListener('click', function () {
          // remove old active
          tabsObj[i].panel.classList.remove('active');
          tabsObj[i].content.classList.toggle('active'); // add new active

          var href = element.dataset.href;
          tabsObj[i].panel = element;
          element.classList.add('active');
          var content = document.querySelector("[data-tab=\"".concat(href, "\"]"));
...
__webpack_require__(/*! /home/lit/Code/vay/web/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/lit/Code/vay/web/resources/css/app.css */"./resources/css/app.css");
