<div class="light-blue">
    <div class="container p-10">
        ...
        <p class="text-2xl font-bold">Vay tín chấp ngân hàng lãi suất thấp</p>
        <div class="mt-5 overflow-auto flex flex-col gap-5">
            <p>Vay tín chấp là hình thức cho vay tiền không cần tài sản đảm bảo, ngân hàng hoặc tổ chức tài chính cho vay dựa trên uy tín của cá nhân hoặc công ty mà cá nhân đó làm việc để quyết định cho vay hay không. Hạn mức vay tín chấp dao động từ 10 đến 600 triệu với thời gian vay từ 6 đến 60 tháng.</p>
            <p>Hiện nay, các công ty tài chính và ngân hàng triển khai rất nhiều hình thức vay tín chấp nhằm tạo điều kiện cho khách hàng chọn được sản phẩm phù hợp với điều kiện và nhu cầu của mình.</p>
        </div>
    </div>
</div>

<x-block title="Ưu điểm của hình thức vay tín chấp">
    <div data-type="slideable">
        <div class="grid md:grid-cols-3 gap-5 mt-10">
            <x-service-item title="Hạn mức vay cao" desc="Số tiền vay tối đa gấp 6-15 lần thu nhập hàng tháng, tối đa 600 triệu">
                <x-slot name="image">
            ...
            <x-service-item title="Không thế chấp tài sản" desc="Khách hàng không cần thế chấp tài sản, không cần bảo lãnh của công ty">
                <x-slot name="image">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                         id="Layer_1" x="0px" y="0px" viewBox="0 0 469.333 469.333"
                         style="enable-background:new 0 0 469.333 469.333;" xml:space="preserve" width="512px"
            ...
            <x-service-item title="Thời gian vay dài" desc="Thời gian vay từ 6-60 tháng giúp khách hàng giảm áp lực trả nợ">
                <x-slot name="image">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                         id="Layer_1" x="0px" y="0px" viewBox="0 0 469.333 469.333"
                         style="enable-background:new 0 0 469.333 469.333;" xml:space="preserve" width="512px"
